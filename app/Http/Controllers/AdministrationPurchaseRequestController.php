...
class AdministrationPurchaseRequestController extends Controller
{
    /**
    ...
    {
        $purchases = PurchaseRequest::all();
        return view('admin.purchase_requests.index', ['purchases' => $purchases]);
    }
